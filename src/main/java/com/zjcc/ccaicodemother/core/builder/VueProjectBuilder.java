package com.zjcc.ccaicodemother.core.builder;
...
public class VueProjectBuilder {
    ...
    /**
     * 异步构建 Vue 项目 性能优化
     * 打包构建是个耗时操作，为了不阻塞主流程，使用 Java 21 的虚拟线程特性，在单独的线程中执行构建
     * 异步构建的优点是提高系统的并发量，但缺点是可能会导致前端无法实时浏览到 AI 生成的网站
     * @param projectPath
     */
