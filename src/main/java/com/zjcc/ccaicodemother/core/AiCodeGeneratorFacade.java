...
import com.zjcc.ccaicodemother.ai.AiCodeGeneratorServiceFactory;
...
public class AiCodeGeneratorFacade {
     ...
     * TODO 代码优化 设计模式-适配器  抽离单独适配器类 和通用流式代码处理 processCodeStream方法组成不同适配器
     * 监听 tokenStream 的 AI 响应、工具调用、工具调用完成等事件，将不同事件封装为不同的消息
